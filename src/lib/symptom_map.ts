...
const FAILURE_SYNONYMS: Record<string, FailureMode> = {
  ...
  "won't power up": "Won't Start", "wont power up": "Won't Start",
  "won't turn on": "Won't Start", "wont turn on": "Won't Start",
  "no power": "Won't Start",
  "not working": "Won't Start",
  "not working properly": "Won't Start",
  "no response": "Won't Start",
  "dead": "Won't Start",
  "stopped working": "Won't Start",
